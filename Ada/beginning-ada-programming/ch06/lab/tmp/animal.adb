...
package body Animal is
  ...
  procedure Set_Name(Creat : in out Creature; Name : String) is
  begin
    Creat.Name := Ada.Strings.Unbounded.To_Unbounded_String(Name);
  end Set_Name;
  ...
  function Get_Name(Creat : in out Creature) return String is
  begin
    return Ada.Strings.Unbounded.To_String(Creat.Name);
  end Get_Name;
